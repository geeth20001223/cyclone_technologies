...
MAIL_USERNAME=${MAIL_USERNAME:-shamal.geethanjanpathirana@gmail.com}
MAIL_PASSWORD=${MAIL_PASSWORD:-okkrjlqslfpfnute}
MAIL_ENCRYPTION=${MAIL_ENCRYPTION:-tls}
MAIL_FROM_ADDRESS=${MAIL_FROM_ADDRESS:-shamal.geethanjanpathirana@gmail.com}
