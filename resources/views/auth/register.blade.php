...
<head>
    <meta charset="utf-8">
    <title>CYCLONE TECHNOLOGIES | Register</title>
                ...
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                            ...
                            <div class="login_wrap widget-taber-content p-30 background-white border-radius-5">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" style="font-weight: 600; color: #333;">Mobile Number (for SMS Authentication) *</label>
                                                <input type="text" required="" name="phone" value="{{ old('phone') }}" placeholder="Mobile Number (e.g. +16412006289)">
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="col-lg-6">
                               <img src="user/assets/imgs/login.jpg">
                            </div>
                        </div>
                    </div>
                </div>
