                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{url('product_details', $product->id)}}">
                                            @if(in_array(strtolower(pathinfo($product->image, PATHINFO_EXTENSION)), ['mp4', 'webm', 'ogg', 'mov', 'avi']))
                                                <video class="default-img" src="/products_images/{{$product->image}}" muted loop autoplay playsinline style="width: 100%; height: 100%; object-fit: cover;"></video>
                                                <video class="hover-img" src="/products_images/{{$product->image}}" muted loop autoplay playsinline style="width: 100%; height: 100%; object-fit: cover;"></video>
                                            @else
