...
<head>
    <meta charset="utf-8">
    <title>CYCLONE TECHNOLOGIES | My Cart</title>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="image product-thumbnail">
                                            @if(in_array(strtolower(pathinfo($cart->image, PATHINFO_EXTENSION)), ['mp4', 'webm', 'ogg', 'mov', 'avi']))
                                                <video src="products_images/{{$cart->image}}" style="width: 80px; height: 80px; border-radius: 5px; object-fit: cover;" muted loop autoplay></video>
                                            @else
                                                <img src="products_images/{{$cart->image}}" alt="product_image">
                                            @endif
                                        </td>
                                        ...
                                        <td class="price" data-title="Price"><span>Rs. {{ ltrim($cart->price/$cart->quantity, '$') }} </span></td>
                        ...
                        <div class="cart-action text-end">
                            ...
                            <a href="{{route('user.checkout')}}" class="btn"> <i class="fi-rs-box-alt mr-10"></i> Proceed to Checkout(Rs. {{ ltrim($totalPrice, '$') }})</a>
                        </div>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><strong><span class="font-xl fw-900 text-brand">Rs. {{ ltrim($totalPrice, '$') }}</span></strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
