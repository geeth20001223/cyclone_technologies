...
<head>
    <base href="/public">
    <meta charset="utf-8">
    <title>CYCLONE TECHNOLOGIES | Product Details</title>
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                @if(in_array(strtolower(pathinfo($product->image, PATHINFO_EXTENSION)), ['mp4', 'webm', 'ogg', 'mov', 'avi']))
                                                    <video src="/products_images/{{$product->image}}" controls autoplay muted loop style="width: 100%; border-radius: 10px;"></video>
                                                @else
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">Rs. {{ ltrim($product->discount_price, '$') }}</span></ins>
                                                <ins><span class="old-price font-md ml-15">Rs. {{ ltrim($product->price, '$') }}</span></ins>
                                            ...
                                            <form action="{{url('add-to-cart',$product->id)}}"  method="post">
                                                ...
                                                <div class="product-extra-link2">
                                                    ...
                                                    @if(Auth::id() != $product->user_id)
                                                        <a href="{{ route('messages.start', $product->id) }}" class="btn-chat-seller">
