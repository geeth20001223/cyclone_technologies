                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-group col-sm-9">
                                            @if(in_array(strtolower(pathinfo($product->image, PATHINFO_EXTENSION)), ['mp4', 'webm', 'ogg', 'mov', 'avi']))
                                                <video id="showImage" style="width: 40%; border-radius: 3%;" src="/products_images/{{$product->image}}" muted controls></video>
                                            @else
            ...
            $('#image').change(function(e) {
                ...
                reader.onload = function(e) {
                    ...
                    if (fileType.startsWith('video/')) {
                        container.append('<video id="showImage" style="width: 40%; border-radius: 3%;" src="' + e.target.result + '" muted controls></video>');
                    } else {
                        container.append('<img id="showImage" style="width: 40%; border-radius: 3%;" src="' + e.target.result + '" alt="product_image">');
                    }
                };
