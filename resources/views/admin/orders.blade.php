      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <form action="{{url('/search-order')}}" class="nav-link mt-2 search col-12 col-md-6 mb-3" method="GET">
              @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(in_array(strtolower(pathinfo($order->image, PATHINFO_EXTENSION)), ['mp4', 'webm', 'ogg', 'mov', 'avi']))
                                                <video src="products_images/{{$order->image}}" style="max-width: 60px; border-radius: 5px;" muted autoplay loop></video>
                                            @else
